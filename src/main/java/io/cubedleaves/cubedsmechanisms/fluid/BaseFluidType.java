...
public class BaseFluidType extends FluidType {
    ...
    public void initializeClient(Consumer<IClientFluidTypeExtensions> consumer) {
        consumer.accept(new IClientFluidTypeExtensions() {
            ...
            @Override
            public @NotNull Vector3f modifyFogColor(Camera camera, float partialInt, ClientLevel level, int renderDistance, float darkenWorldAmount, Vector3f fluidFogColor) {
                return fogColor;
            }
            @Override
