...
import io.cubedleaves.simplemeckanisms.Init.custom.item.InfinityCrystal;
...
public class iteminit {
    public static final DeferredRegister<Item> ITEMS = DeferredRegister.create(ForgeRegistries.ITEMS, SimpleMeckanisms.MOD_ID);
